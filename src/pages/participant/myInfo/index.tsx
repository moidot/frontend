...
const MyInfoUpdatePage = () => {
  ...
  return (
    <div>
      ...
      <div className="font-Pretendard w-full tablets:w-[1200px] mx-auto pt-4 tablets:pt-9">
        <div className="w-full items-center flex justify-center mx-auto mb-[30px] tablets:mb-[56px]">
          <div className="text-[20px] tablets:text-h2 text-font_black font-bold">내 정보 수정하기</div>
          <div className="text-[14px] tablets:text-b2 text-font_black pl-1 text-center">
            <span>{router?.query.teamName}</span>
            <span className="pl-[8px] tablets:pl-[16px] text-font_gray">{router?.query.date}</span>
          </div>
        </div>
        {/* 닉네임 */}
        <div className="w-[90%] tablets:w-[586px] mx-auto mb-[30px] tablets:mb-[40px]">
          <div className="w-full mb-3 flex justify-between items-center">
            <label className="text-[16px] tablets:text-b1 text-font_black">닉네임</label>
            <div className="text-font_gray text-[12px] tablets:text-b3">공백포함 {name.length} / 8자</div>
          </div>
          <div className="w-full relative">
            <input
              ...
              maxLength={8}
              className="w-full h-[60px] tablets:h-[72px] pl-4 tablets:pl-6 rounded-2xl bg-bg_orange text-b2 text-font_black outline-none"
            />
            <Pencil
              className="absolute top-4 tablets:top-5 right-4 tablets:right-6 cursor-pointer"
        ...
        <div className="w-[90%] tablets:w-[586px] mx-auto mb-[30px] tablets:mb-[40px]">
          <div className="flex flex-row items-center mb-[12px]">
            <div className="text-[16px] tablets:text-b1 text-font_black">출발 위치</div>
          </div>
          <div className="relative w-full h-[60px] tablets:h-[72px] pt-[16px] tablets:pt-[20px] pb-[16px] tablets:pb-[20px] pl-[16px] tablets:pl-[24px] pr-[16px] tablets:pr-[24px] rounded-2xl bg-bg_orange flex flex-row items-center justify-between">
        ...
        {/* 이동 수단 */}
        <div className="w-[90%] tablets:w-[586px] mx-auto mb-[30px] tablets:mb-[34px]">
          <div className="mb-3">
        ...
        <div
          className="cursor-pointer flex w-[90%] tablets:w-[585px] h-[60px] tablets:h-[78px] items-center justify-center bg-main_orange rounded-2xl mx-auto mb-[50px] tablets:mb-[92px] text-white text-[16px] tablets:text-b1 font-bold"
          onClick={onNextClick}>
          수정하기
        </div>
        {/* 팝업 - 임시 데이터 */}
        {isClickedPatch && (
          <CommonPopupBackground>
            <div className="flex justify-center h-[100vh] items-center font-Pretendard">
              <div className="w-[90%] tablets:w-[790px] h-[300px] tablets:h-[367px] rounded-2xl bg-white">
                <div className="text-[18px] tablets:text-h3 my-[24px] tablets:my-[33px] text-center text-font_black font-bold">
                  수정이 완료되었습니다.
                </div>
                <div className="w-[90%] tablets:w-[378px] mx-auto text-[14px] tablets:text-b2 mb-[12px]">
                  <span className="text-font_gray mr-[16px] tablets:mr-[24px]">출발위치</span>
                  <span>{location.location}</span>
                </div>
                <div className="w-[90%] tablets:w-[378px] mx-auto text-[14px] tablets:text-b2 flex items-center">
                  <span className="text-font_gray mr-[16px] tablets:mr-[24px]">이동수단</span>
                  <div className="w-[32px] tablets:w-[40px] h-auto">
                    {isPublic ? (
                ...
                <div className="flex w-[90%] tablets:w-[585px] mt-[32px] tablets:mt-[45px] mx-auto">
                  <button
                    type="button"
                    className="w-full h-[60px] tablets:h-[78px] rounded-2xl bg-main_orange text-white text-[16px] tablets:text-b1 font-bold flex items-center justify-center"
